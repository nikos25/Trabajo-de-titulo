        ...
        <div class="modal-content">
            ...
            <form action="" class="col-12" method="POST" action="">
                ...
                <div class="form-group" id="descripcion-group">
                    <input type="text" class="form-control" placeholder="Nombre del patrocinador" name="Nombre" value="{{$patro -> nombre}}">
                </div>
                <div class="form-group" id="descripcion-group">
                    <input type="text" class="form-control" placeholder="Descripcion" name="Descripcion" value="{{$patro -> descripcion}}">
                </div>
